...
public class AutoJsonContextGenerate : IIncrementalGenerator
{
    ...
    private void Execute(Compilation compilation, ImmutableArray<ClassDeclarationSyntax> classes, SourceProductionContext context, string? AssemblyName)
    {
        ...
        var attributeSymbol = compilation.GetTypeByMetadataName("MFToolkit.AutoAttribute.JsonContextGenerate.AutoJsonGenerateAttribute`1");
        var nonGenericAttributeSymbol = compilation.GetTypeByMetadataName("MFToolkit.AutoAttribute.JsonContextGenerate.AutoJsonGenerateAttribute");
        var nameSpaceAttributeSymbol = compilation.GetTypeByMetadataName("MFToolkit.AutoAttribute.JsonContextGenerate.AutoJsonGenerateNameAttribute");
    ...
    private ServiceRegistration? ParseAttribute(INamedTypeSymbol classSymbol, AttributeData attribute, string? nameSpace)
    {
        ...
        string targetNamespace = nameSpace != null ? nameSpace + ".JsonContextGenerated.AutoGenerated" : GetTargetNamespace(classSymbol.ContainingNamespace.ToDisplayString());
    ...
    private static string GetTargetNamespace(string originalNamespace)
    {
        ...
        return string.IsNullOrEmpty(parentNamespace)
            ...
            : $"{parentNamespace}.JsonContextGenerated.AutoGenerated";
    }
