...
namespace MFToolkit.Avaloniaui.Content;
...
// Material Icons
    public static readonly StreamGeometry FileOpen = Parse(
...
// Material Icons
    public static readonly StreamGeometry WindowRestore =
        Parse("M4,8H8V4H20V16H16V20H4V8M16,8V14H18V6H10V8H16M6,12V18H14V12H6Z");

// Material Icons
    public static readonly StreamGeometry WindowMaximize = Parse("M4,4H20V20H4V4M6,8V18H18V8H6Z");

// Material Icons
    public static readonly StreamGeometry WindowClose =
        Parse(
...
// Material Icons
    public static readonly StreamGeometry Calendar =
        Parse(
...
// Material Icons
    public static readonly StreamGeometry Login =
        Parse(
...
// Material Icons
    public static readonly StreamGeometry ChevronUp =
        Parse("M7.41,15.41L12,10.83L16.59,15.41L18,14L12,8L6,14L7.41,15.41Z");

// Material Icons
    public static readonly StreamGeometry ChevronDown =
        Parse("M7.41,8.58L12,13.17L16.59,8.58L18,10L12,16L6,10L7.41,8.58Z");

// Material Icons
    public static readonly StreamGeometry ChevronLeft =
        Parse("M15.41,16.58L10.83,12L15.41,7.41L14,6L8,12L14,18L15.41,16.58Z");

// Material Icons
    public static readonly StreamGeometry ChevronRight =
        Parse("M8.59,16.58L13.17,12L8.59,7.41L10,6L16,12L10,18L8.59,16.58Z");

// Material Icons
    public static readonly StreamGeometry CircleCheck =
        Parse(
            "M12 2C6.5 2 2 6.5 2 12S6.5 22 12 22 22 17.5 22 12 17.5 2 12 2M10 17L5 12L6.41 10.59L10 14.17L17.59 6.58L19 8L10 17Z");

// Material Icons
    public static readonly StreamGeometry CircleWarning =
        Parse(
            "M13,13H11V7H13M13,17H11V15H13M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2Z");

// Material Icons
    public static readonly StreamGeometry CircleInformation =
        Parse(
...
// Material Icons
    public static readonly StreamGeometry CircleOutline =
        Parse(
...
// Material Icons
    public static readonly StreamGeometry CircleOutlineClose = Parse(
...
// Material Icons
    public static readonly StreamGeometry CircleOutlinePlus =
        Parse(
...
// Material Icons
    public static readonly StreamGeometry CircleOutlineMinus =
        Parse(
...
// Material Icons
    public static readonly StreamGeometry CircleOutlineCheck =
        Parse(
...
// Material Icons
    public static readonly StreamGeometry KeyboardCaps =
        Parse("M6,18H18V16H6M12,8.41L16.59,13L18,11.58L12,5.58L6,11.58L7.41,13L12,8.41Z");

// Material Icons
    public static readonly StreamGeometry BackspaceOutline = Parse(
...
// Material Icons
    public static readonly StreamGeometry ArrowLeft =
        Parse("M20,11V13H8L13.5,18.5L12.08,19.92L4.16,12L12.08,4.08L13.5,5.5L8,11H20Z");

// Material Icons
    public static readonly StreamGeometry ArrowRight =
        Parse("M4,11V13H16L10.5,18.5L11.92,19.92L19.84,12L11.92,4.08L10.5,5.5L16,11H4Z");

// Material Icons
    public static readonly StreamGeometry Menu = Parse("M3,6H21V8H3V6M3,11H21V13H3V11M3,16H21V18H3V16Z");

// Material Icons
    public static readonly StreamGeometry Star =
        Parse("M12,17.27L18.18,21L16.54,13.97L22,9.24L14.81,8.62L12,2L9.19,8.62L2,9.24L7.45,13.97L5.82,21L12,17.27Z");
}